...
| --- | --- | --- | --- |
| One component | 7 files, 13.9 kB | 4 files, 6.2 kB | 55% |
| Two components | 11 files, 15.4 kB | 7 files, 6.8 kB | 56% |
| A 13-tag landing page | 37 files, 38.6 kB | 20 files, 23.2 kB | 40% |
| The whole library | 125 files, 85.8 kB | **1 file, 43.9 kB** | 49% |
